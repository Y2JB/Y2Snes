...
namespace WinFormRender
{
    public partial class ConsoleWindow : Form
    {
        ...
        public ConsoleWindow(SuperFamicom snes, SnesDebugConsole dbgConsole)
        {
            this.snes = snes;
        ...
        public void RefreshDmgSnapshot()
        {
            ...
            dmgSnapshot.AppendText((dbgConsole.SnesMode == SnesDebugConsole.Mode.BreakPoint) ? "BREAK" : "RUNNING");

            dmgSnapshot.AppendText(Environment.NewLine);
            dmgSnapshot.AppendText(snes.cpu.ToString());
